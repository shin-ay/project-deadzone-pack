...
- PDZ Boss 01-14 each has a dedicated state. Boss 01-13 use concept-matched
  long-form cues; Boss 14 temporarily pins boss_last_stand for the first playtest.
...
- Full restart is required after adding the new mob-effect states. After that,
  /pdzbgmtest music_boss_01 through music_boss_14 can audition each cue.
