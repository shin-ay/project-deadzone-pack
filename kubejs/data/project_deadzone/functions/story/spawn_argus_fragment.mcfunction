summon pdzbosses:argus_fragment ~ ~ ~ {PersistenceRequired:1b,Tags:["dz_story_boss","dz_story_boss_argus_fragment"],CustomName:'{"text":"ARGUS FRAGMENT","color":"gold","bold":true}',CustomNameVisible:1b}
