...
data modify entity @e[type=easy_npc:humanoid,tag=dz_basecamp_buddy_recruiter,limit=1] DialogData.DialogDataSet[0].Buttons append value {Actions:[{Cmd:"/deadzonebuddy status",ExecAsUser:1b,PermLevel:0,Type:"COMMAND"}],Label:"pmc_roster",Name:"PMC契約枠を確認する"}
