...
function pdzLedgerStatus(player){
  ...
  player.tell(Text.of('World Tier T'+pdzLedgerWorldTier(player)+'｜JOB '+job+'｜T2 '+t2+'｜T3 '+t3).aqua())
  ...
  player.tell(pdzLedgerLink('勢力判断','/deadzonestorybranch status','yellow').append(Text.of(' ')).append(pdzLedgerLink('World Tier','/deadzonetier status','lightPurple')).append(Text.of(' ')).append(pdzLedgerLink('クエスト区分','/deadzonequests','gray')))
  return 1
}
