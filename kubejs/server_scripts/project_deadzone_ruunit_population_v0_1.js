...
EntityEvents.spawned('simpleenemymod:ruunit',event=>{
  ...
  e.server.scheduleInTicks(20,()=>{
    if(!e || !e.alive || e.tags.contains('dz_raider') || e.tags.contains('dz_story_npc') ||
       e.tags.contains('dz_story_boss') || e.tags.contains('dz_elite') || e.tags.contains('dz_t0_convoy') ||
       e.tags.contains('dz_boss_showroom') || e.tags.contains('dz_boss_loadtest'))return
